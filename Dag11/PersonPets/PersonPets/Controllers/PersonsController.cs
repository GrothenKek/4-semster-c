...
namespace PersonPets.Controllers
{
    public class PersonsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Name,Age,Weight,Score")] Persons persons)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Name,Age,Weight,Score")] Persons persons)
        {
            if (ModelState.IsValid)
            {
