namespace CodeFirst.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CodeFirst.DataContext.RentServiceContext>
    {
        ...
        protected override void Seed(CodeFirst.DataContext.RentServiceContext context)
        {
                ...
                var res1 = new Reservation { ResId = 1, StartDate = DateTime.Now, EndDate = new DateTime(2021, 4, 30), StorageStatus = ResStatus.Reserved, ToolId = 1, CustomerId = "TorbenClausenl@gmail.com" };
                var res2 = new Reservation { ResId = 2, StartDate = DateTime.Now, EndDate = new DateTime(2021, 4, 30), StorageStatus = ResStatus.Reserved, ToolId = 2, CustomerId = "DollarClaus@gmail.com" };
                var res3 = new Reservation { ResId = 3, StartDate = DateTime.Now, EndDate = new DateTime(2021, 4, 20), StorageStatus = ResStatus.Reserved, ToolId = 3, CustomerId = "SlankeDex@gmail.com", };
                var res4 = new Reservation { ResId = 4, StartDate = DateTime.Now, EndDate = new DateTime(2021, 4, 20), StorageStatus = ResStatus.Reserved, ToolId = 5, CustomerId = "SlankeDex@gmail.com", };
